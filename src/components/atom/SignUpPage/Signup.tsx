    ...
    <>
      <div className="lg:bg-gradient-to-b lg:from-[#151515] lg:via-[#603114] lg:to-[#FF6F13] bg-[radial-gradient(circle_at_top,_#FF6F13_0%,_#151515_50%,_#0F0F0F_100%)] pt-12 h-screen">
        <div className="flex flex-col justify-between items-center">
          ...
          <center className="lg:pt-12">
            <h1
              className={`${orbitrondesc.className} font-bold uppercase text-xs lg:text-xl text-white lg:mt-4 mt-24`}
            >
              BE FIRST. BE LOUD. BE THE SHIFT.
            </h1>
            <h1
              className={`${orbitron.className} font-bold uppercase text-2xl lg:text-4xl bg-gradient-to-b from-[#FFFFFF] to-[#FF7822] bg-clip-text text-transparent mt-2 lg:mt-4`}
            >
              <i>Let's Build the Future of F 1 Together</i> !
            </h1>
          </center>
          <div className="mt-8 lg:mt-8 bg-[#FF7A00] text-black px-2 py-2 rounded-full font-bold shadow-lg hover:scale-105 transition text-sm lg:text-md">
            <button className="">
              <div className="flex flex-row items-center justify-center lg:justify-start">
                <h2
                  className={`${orbitrondesc.className} font-bold text-base lg:text-lg font-bold uppercase px-2`}
                >
                  Get early access
                </h2>
          ...
          <div className="hidden lg:block flex flex-1 justify-end items-center mt-10">
            <Image
           ...
           <div className="block lg:hidden flex flex-1 justify-end items-center mt-10">
            <Image
